...
pub fn part_two(input: &str) -> Option<u32> {
    ...
    for line in &lines {
        ...
        for line_number in 1..line_results.len() {
            ...
            last_result_number = line_results[reverse_line_number][0] - line_results[reverse_line_number + 1][0];

            line_results[reverse_line_number].insert(0, last_result_number);
        }
